...
document.addEventListener("DOMContentLoaded", () => {
  const booster = document.getElementById("boosterBox");
  if (!booster) return;
  booster.style.display = "none";
document.getElementById("homeBottom").onclick = () => {
    booster.style.display = "none";
  };
document.getElementById("functionBottom").onclick = () => {
    booster.style.display = "none";
  };
document.getElementById("monitorBottom").onclick = () => {
